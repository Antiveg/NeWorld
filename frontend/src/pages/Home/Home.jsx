...
const Home = () => {
    ...
    const features = [
        ...
        },
        {
          ...
          "desc": "NeWorld's About Page contains my own dream NeWorld. You can imagine my own 'NeWorld' and the stories behind it, but you also have the chance to write about your dreams for a world that aligns with your values and goals."
        }
    ];
